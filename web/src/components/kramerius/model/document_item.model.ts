export class DocumentItem {
	...
	resolveUrl(prefix: string) {
		if (
			this.doctype === 'periodical' ||
			this.doctype === 'periodicalvolume' ||
			this.doctype === 'convolute'
		) {
	...
	public getUuidFromContext(doctype: string): string | null | undefined {
	...
	public getParentUuid(): string | null | undefined {
	...
	public getParentDoctype(): string | undefined {
		if (this.context && this.context.length > 1) {
